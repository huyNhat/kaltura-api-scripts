...
#Setting log file
logging.basicConfig(filename="logs/kaltura-prod-subset-logs-1",
                            filemode='a',
...
def getDatabyPage():
    ...
    pager.pageSize = pageSize #max is 500
...
def main():
    ...
    print("Num of subset entries processed :" +str(totalNumOfSubsetEntries))
